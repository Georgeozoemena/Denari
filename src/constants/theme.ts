 ...
 * 
 * Inspired by: Kuda, Revolut, Monzo, Linear, Stripe (principles only)
 * Brand colors, logo, and identity remain unchanged
...
export const Colors = {
  light: {
    // Brand Identity (DENARI Orange - use sparingly)
    primary: '#FD7E15',
    primaryHover: '#E66D00',
    primarySoft: '#FFF0E6',
    
    // Backgrounds (White-based, clean)
